...
function mktrbook(S) {
	...
	function fns() {
		// XXX temporary special case
		// (The link between those three files will soon
		// be encoded in the database; the san-zi-jing-fr.src
		// was a quick hack already)
		if (S.book == "san-zi-jing-fr") return [
			"data/books/san-zi-jing.src",
