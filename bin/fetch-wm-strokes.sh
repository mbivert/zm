...
# Imported from previous repository. Original goal was to have a
# local cache of the WikiMedia images for politeness' sake.
#
# This should be extended to support ancient forms, but we're not sure
# which category regroups all files yet.
