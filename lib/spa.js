...
function init(to, root, prefs) {
	...
	if (User.prefs.fonts.length)
		Dom.loadfont(Config.root+"/fonts/"+User.prefs.fonts[0])
...
*/
		...
		document.addEventListener("click", function(e) {
			...
			// XXX The spec requires a PointerEvent, but Firefox
			// generates a MouseEvent (PointerEvent inherits from
			// MouseEvent so this still work)
